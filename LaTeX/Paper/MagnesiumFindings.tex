...
\begin{figure}[ht]
	...
	\subfloat[SubFigure 1][Distance]{
		\resizebox{.45\textwidth}{!}{\input{../TeXoutput/distSurv.tex}}	
		\label{fig:distSurv}} &
    ...
    \multicolumn{2}{c}{\subfloat[SubFigure 3][GDP per Capita]{
        \resizebox{.45\textwidth}{!}{\input{../TeXoutput/gdpSurv.tex}}	
        \label{fig:gdpSurv}} }
