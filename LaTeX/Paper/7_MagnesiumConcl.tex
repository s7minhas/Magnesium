...
% SM: that last sentence in the above paragraphs reads like we find support for the trade argument, but we dont, did you mean something else or am I missing something?
% CD: No thats an error. What I have now should be correct (looking at model 3)
...
%%CD: my only remaining concerns in that this is too short. Can we think of an 'implications' type conclusion? Probably not since we couldn't use anecdotes. Maybe a "future research" type statement? The best I came up with was this last sentence. 
\newpage
\section*{Appendix}
\label{appendix}
