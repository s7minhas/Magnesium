\documentclass[12pt,onesided, reqno]{amsart} 
...
\usepackage{array}
\usepackage{amsmath}
\newcommand\numberthis{\addtocounter{equation}{1}\tag{\theequation}} % eqn numbering for align
\usepackage{amssymb}
\usepackage{amsfonts}
...
% \email{shahryar.minhas@duke.edu}
 ...
 \thanks{\singlespacing{
 \noindent Corresponding author email: cassyld@gmail.com; University of New Mexico,  Department of Political Science, 1 University of New Mexico, Albuquerque, NM 87131-0001}}
...
%%%%%%%% INTRO %%%%%%%%
\input{2_MagnesiumIntro}
%%%%%%%%%%%%%%%%%%%%%%%

%%%%% Lit Review %%%%%
\input{3_MagnesiumLit}
%%%%%%%%%%%%%%%%%%%%%%

%%%%% Theory %%%%%
\input{4_MagnesiumTheory}
%%%%%%%%%%%%%%%%%%%%%%

%%%%% Empirics %%%%%
\input{5_MagnesiumEmp}
%%%%%%%%%%%%%%%%%%%%%%

%%%%% Empirics %%%%%
\input{6_MagnesiumFindings}
%%%%%%%%%%%%%%%%%%%%%%

%%%%% Conclusion %%%%%
\input{7_MagnesiumConcl}
%%%%%%%%%%%%%%%%%%%%%%
