...
\begin{figure}[ht]
    ...
    \resizebox{.55\textwidth}{!}{\input{../TeXoutput/gdpSurv_all.tex}}	
	\label{fig:monSurv}
\end{figure}
...
\begin{figure}[ht]
	...
	\resizebox{0.55\textwidth}{!}{\input{../TeXoutput/nosSurv_all.tex}}
	\label{fig:nosSurv}
\end{figure}
...
\begin{figure}[ht]
	...
	\subfloat[Subfigure 1][Compliance Reciprocity]{
		\resizebox{.45\textwidth}{!}{\input{../TeXoutput/compRecSurv_all.tex}}
		\label{fig:compSancSurv}} & 
	
	\subfloat[Subfigure 2][Sanction Reciprocity]{
		\resizebox{.45\textwidth}{!}{\input{../TeXoutput/sancRecSurv_all.tex}}
		\label{fig:compSancSurv}}	
...
\begin{figure}[ht]
	...
	\resizebox{1\textwidth}{!}{\input{../TeXoutput/crossvalPerf.tex}}
	\label{fig:auc}
\end{figure}