...
\emph{To specifically respond to what compliance really means (i.e. is it ``doing everything the sender asks?": Compliance reciprocity includes both partial and full acquiescence, i.e. ``We consider the target of a sanction to have complied, if the target state completely or partially acquiesces to the demands of the sanction senders or negotiates a settlement." Our definition and operationalization of compliance are from Bapat and Morgan (2009,  pg.12). Theoretically, we make no distinction that partial or full acquiesces.}
