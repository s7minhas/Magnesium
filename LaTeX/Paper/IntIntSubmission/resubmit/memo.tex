...
\emph{These are fair concerns, and we have tried to be much more careful and precise about our language. We see benefit in leaving the DV as ``dyadic'' while incorporating network attributes on the right-hand side of the mode. While we think that reciprocity matters over time we have now limited our claims around endogenity which we cannot systematically capture.}
