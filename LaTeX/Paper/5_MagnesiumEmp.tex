...
where $i$ represents the target of the sanction, $j$ represents the relationship between the set of sender(s) for a particular sanction case and $i$, and $t$ the time period -- $No. \; Senders_{j}$ + $Distance_{j}$ are time-invariant variables.
