...
\frametitle{Institutions Hypothesis}
	Sanctions impose costs on groups within the country.  Affected roups will try to lobby the government to reach an accommodation with sanctioning states. 
	\begin{itemize}
	\item \textbf{H3} Target states with stronger democratic institutions will comply more quickly than those without democratic processes. 
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
