...
\title{Effects of Sanctions on Structure of International System}
\author{	Cassy Dorff \\
...
General questions: How do sanctions change the structure of the international system

	-- need to measure sanctions
	-- choose dv, current options: trade flows, diplomatic visits
